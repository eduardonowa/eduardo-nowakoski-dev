...
const technologies = [
  ...
  { name: 'RxJS', icon: Layers, color: 'text-red-400' },
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl relative" style={{ zIndex: 1 }}>
        ...
        >
          <div className="flex items-start gap-1 text-primary mb-4 justify-center md:inline-flex md:items-center md:gap-2">
            <Code2 className="w-6 h-6 flex-shrink-0 mt-1 md:mt-0" aria-hidden="true" />
            <h2 id="technologies-title" className="text-3xl md:text-4xl font-bold text-text leading-tight inline-block max-w-[50%] sm:max-w-none">
